...
function Blog() {
  return (
    <>
      ...
      <section
        id="blog"
        className="blog style-2 padding-tb"
      >
                ...
                <div className="post-content d-flex flex-wrap">
                  ...
                  <div className="content-part">
                    <div className="entry-header">
                      <h4>
                        <a href="#">
                          Globan Emper Extenve As Chane Exens Best Awesome
                        </a>
                      </h4>
                    </div>
                    <div className="entry-content">
                      <p>
                        ...
                        Sed mauris vitae erat consequat auctor as euin elitin
                        Class ptent inceptos himenaeos.
                      </p>
                      <a
                        href="#"
