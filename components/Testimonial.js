...
function Testimonial() {
  ...
  return (
    <>
      ...
      <section
        className="testimonial-section padding-tb"
        style={{
          backgroundImage: "url(assets/images/testimonial/bg-image.jpg)",
          ...
          >
            ...
            <h1>
              <span style={{ fontWeight: 400 }}>
                Client’s Feedback Latest Reviews From My Clients
              </span>
            </h1>
          </div>
          <div
                    ...
                    <div className="post-header">
                      ...
                      <div className="sponsor-thumb">
                        <Image
                          width={500}
                          height={500}
                          src="/assets/images/testimonial/icon1.png"
                          alt="testimonial"
                        />
                      </div>
                    </div>
                    ...
                    <div className="post-header">
                      ...
                      <div className="sponsor-thumb">
                        <Image
                          width={500}
                          height={500}
                          src="/assets/images/testimonial/icon2.png"
                          alt="testimonial"
                        />
                      </div>
                    </div>
                    ...
                    <div className="post-header">
                      ...
                      <div className="sponsor-thumb">
                        <Image
                          width={500}
                          height={500}
                          src="/assets/images/testimonial/icon3.png"
                          alt="testimonial"
                        />
                      </div>
                    </div>
